...
<div class="content">
    <div class="container">
        ...
        <div class="breadcrum my-3">
            ...
            <span>
                <a href="{{ route('category.show', $product->category->slug) }}" class="text-dark text-decoration-none" style="letter-spacing: 1px;">
                                        ...
                                        @foreach ($product->Product_Variants as $variant)
                                            <li class="product__size--item border border-dark mx-1" style="border-radius: 4px;">
                                                <label style="cursor:pointer;" class="w-100 h-100 py-1 px-2" onclick="this.form.submit()">
                                                    <input type="radio" hidden name="variant_id" value="{{ $variant->id_variant }}"
