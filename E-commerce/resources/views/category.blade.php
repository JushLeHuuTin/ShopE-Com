        ...
        <div class="row">
            <div class="col-3 d-none d-lg-block">
                <div class="category">
                    ...
                    <ul class="category__list p-0" style="list-style: none">
                        @foreach ($categories as $item)
                            <li class="category__item py-1">
                                <a href="{{ route('category.show',$item->slug) }}" class="category__item-link text-dark text-decoration-none">{{ $item->name }}</a>
                            </li>
                        @endforeach
                    </ul>
                </div>
            ...
            <div class="col-lg-9 col-12">
                <div class="container-fluid p-0">
                    ...
                    <div class="row content-first border-none mb-4" style="border:none; margin:10px 0">
                        ...
                        @empty
                            <p class="p-3"  style="background-color:#FEF3CD;color:#aa8f4b;">Không tìm thấy sản phẩm nào khớp với lựa chọn của bạn.</p>
                        @endforelse
                    </div>
                </div>
                {{ $products->links() }}
