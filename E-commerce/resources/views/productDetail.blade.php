            ...
            <div class="breadcrum my-3">
                ...
                <span>
                    <a href="{{ route('category.show', $product->category->slug) }}" class="text-dark text-decoration-none"
                        style="letter-spacing: 1px;"> {{ $product->category->name }} > </a>
                </span>
                <span>
                    <a href="" class="text-dark text-decoration-none"
                        style="letter-spacing: 1px;">{{ $product->name }}</a>
                </span>
            </div>
                                                        ...
                                                        <div class="card-body " style="background: #efefef;">
                                                            <div class="card-item">
                                                                <div class="card-infor d-flex gap-3 align-items-center">
                                                                    <img style="width:40px;" src="{{ asset('images/user.png') }}"
                                                                        alt="">
                                                ...
                                                @if ($commentCount > 3)
                                                    <div class="text-center">
                                                        <a class="text-decoration-none fs-5"
                                                            href="{{ route('comment', ['id' => $product->id_product]) }}">Xem tất
                                                            cả đánh giá</a>
                                                    </div>
                                                @endif
                                            @endif
