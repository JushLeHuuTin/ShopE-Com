            ...
            <form method="POST" action="{{ route('promotion.postUpdate') }}" enctype="multipart/form-data">
                ...
                <div class="row g-3 justify-content-center">
                    ...
                    <div class="col-md-8">
                        ...
                        <input value="{{$promotion->name}}" name="name" type="text" class="form-control form-control-sm" />
                        @if ($errors->has('name'))
                    ...
                    <div class="col-md-8">
                        ...
                        <input type="date" value="{{$promotion->start_date}}" name="start_date" class="form-control form-control-sm" max="2099-12-31T23:59" />
                    ...
                    <div class="col-md-8">
                        ...
                        <input type="date" value="{{$promotion->end_date}}" name="end_date" class="form-control form-control-sm" max="2099-12-31T23:59" />
