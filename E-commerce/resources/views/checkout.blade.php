...
<div class="container mt-4">
    ...
    <form action="{{ route('checkout.placeOrder') }}" method="POST" id="checkout-form">
        ...
        <div class="p-3 bg-white border rounded mb-4">
            ...
            <div class="row align-items-center mb-3">
                <div class="col-md-2 text-center">
                    <img src="{{ 'images/' . $item->variant->product->image_url }}"
                        alt="{{ $item->variant->product->name }}" class="img-fluid rounded border">
                </div>
                <div class="col-md-10">
                    <div class="row">
                ...
                <div class="p-3 bg-white border rounded">
                    ...
                    <div class="mb-2">
                        ...
                        <div class="input-group">
                            <input type="text" class="form-control" id="discount-code" name="coupon_code"
                    ...
                    <input type="hidden" name="tong_thanhtoan" id="tong_thanhtoan"
                        value="{{ ($total ?? 0) + 30000 }}">
                </div>
            </div>
        </div>
        ...
        <div
            class="p-3 bg-white border rounded d-flex flex-column flex-md-row justify-content-between align-items-center">
...
<script>
    ...
    function updateTotalAfterDiscount(discountPercent = 0) {
        ...
        document.getElementById('discount-line').style.display = discountPercent > 0 ? 'flex' : 'none';
    ...
    document.getElementById('apply-discount-btn').addEventListener('click', function() {
        ...
        fetch('{{ route("checkout.applyDiscount ") }}', {
            ...
            .then(data => {
                if (data.valid) {
                    updateTotalAfterDiscount(data.discountPercent);
